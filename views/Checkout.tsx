                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        type="text"
                        placeholder="Mumbai"
                        className={`w-full bg-white border-2 ${errors.city ? 'border-red-300' : customer.city ? 'border-green-300' : 'border-gray-200'} focus:border-blue-500 focus:ring-4 focus:ring-blue-100 rounded-xl px-4 py-3 font-medium outline-none transition-all text-base`}
                      />
                    </div>
                  </div>
