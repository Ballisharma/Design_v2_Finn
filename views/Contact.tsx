...
const Contact: React.FC = () => {
   ...
   const structuredData = [
      generateBreadcrumbSchema([
         ...
         { name: 'Contact', url: 'https://jumplings.in/contact' }
      ])
   ];
   ...
   return (
      <div className="animate-fade-in min-h-screen bg-funky-light">
         <SEO
            title="Contact Us | Jumplings - Customer Support & Inquiries"
            description="Get in touch with Jumplings. Email us at hello@jumplings.in or call +91-XXXXXXXXX. Located in New Delhi, India. We'd love to hear from you!"
            keywords="contact jumplings, customer support, sock company contact, new delhi"
