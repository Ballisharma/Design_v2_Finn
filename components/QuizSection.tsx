        ...
        <section className="w-full bg-[#FF8800] py-16 md:py-24 px-4 overflow-hidden relative">
            ...
            <div className="max-w-4xl mx-auto relative">
                ...
                <div className="bg-white rounded-[2.5rem] shadow-xl p-8 md:p-16 text-center relative z-10 mx-4 md:mx-0">
                    ...
                    <div className="absolute -left-12 bottom-0 w-24 h-48 bg-[#1a2b4a] overflow-hidden rounded-r-full hidden md:block" style={{ borderRadius: '0 100px 0 0', transform: 'rotate(-5deg)' }}>
                        <div className="w-4 h-4 bg-white rounded-full absolute top-8 right-6"></div> {/* "Eye" */}
                    </div>
                    <div className="absolute -right-12 bottom-0 w-24 h-56 bg-[#1a2b4a] overflow-hidden rounded-l-full hidden md:block" style={{ borderRadius: '100px 0 0 0', transform: 'rotate(5deg)' }}>
                        <div className="w-4 h-4 bg-white rounded-full absolute top-10 left-6"></div> {/* "Eye" */}
                    </div>


                    <h2 className="font-heading font-black text-[#1a2b4a] text-6xl md:text-7xl lg:text-8xl mb-8 tracking-tighter leading-[0.9]">
                        Find Your <br />
                        Perfect Pair
                    </h2>

                    <p className="font-body text-[#1a2b4a] text-xl md:text-2xl font-medium opacity-80 mb-12 max-w-2xl mx-auto leading-relaxed">
                        Tell us a bit about your vibe and get tailor-made sock recommendations.
                    </p>

                    <Link
                        to="/shop"
                        className="inline-flex items-center gap-3 bg-[#1a2b4a] text-white px-10 py-5 rounded-full font-heading font-bold text-xl hover:bg-[#2a3b5a] transition-all group"
                    >
                        Take Quiz
